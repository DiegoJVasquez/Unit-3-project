...
/* harmony import */ var _pages_utilities_users_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../pages/utilities/users-service */ "./src/pages/utilities/users-service.js");
/* provided dependency */ var React = __webpack_require__(/*! react */ "./node_modules/react/index.js");
  ...
  function _handleSubmit() {
    _handleSubmit = _asyncToGenerator(function* (evt) {
      ...
      try {
        ...
        const user = yield _pages_utilities_users_service__WEBPACK_IMPORTED_MODULE_1__.login(credentials);
        setUser(user);
      } catch (_unused) {
...
function Logo() {
  ...
  }, /*#__PURE__*/React.createElement("div", null, "Diego's"), /*#__PURE__*/React.createElement("div", null, "Shop"));
}
...
function OrderDetail(_ref) {
  ...
  }, "Bring Home New Friends!"), /*#__PURE__*/React.createElement("span", null, order.totalQty), /*#__PURE__*/React.createElement("span", {
    className: _OrderDetail_module_scss__WEBPACK_IMPORTED_MODULE_0__["default"].right
    ...
    _defineProperty(this, "handleSubmit", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(function* (evt) {
        ...
        try {
          ...
          // will resolve to the user object included in the
          // payload of the JSON Web Token (JWT)
          const user = yield (0,_pages_utilities_users_service__WEBPACK_IMPORTED_MODULE_1__.signUp)(formData);
          // Baby step
...
function UserLogOut(_ref) {
  ...
  function handleLogOut() {
    (0,_pages_utilities_users_service__WEBPACK_IMPORTED_MODULE_1__.logOut)();
    setUser(null);
  }
  return /*#__PURE__*/React.createElement("div", {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utilities_items_api__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities/items-api */ "./src/pages/utilities/items-api.js");
/* harmony import */ var _utilities_orders_api__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utilities/orders-api */ "./src/pages/utilities/orders-api.js");
...
function NewOrderPage(_ref) {
  ...
  }, "PAST ORDERS"), /*#__PURE__*/React.createElement(_components_UserLogOut_UserLogOut__WEBPACK_IMPORTED_MODULE_6__["default"], {
    user: user,
    setUser: setUser
...
/* harmony import */ var _utilities_orders_api__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utilities/orders-api */ "./src/pages/utilities/orders-api.js");
/* harmony import */ var _components_Logo_Logo__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/Logo/Logo */ "./src/components/Logo/Logo.js");
...
/***/ "./src/pages/utilities/items-api.js":
/*!******************************************!*\
  !*** ./src/pages/utilities/items-api.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _send_request__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./send-request */ "./src/pages/utilities/send-request.js");
...
/***/ "./src/pages/utilities/orders-api.js":
/*!*******************************************!*\
  !*** ./src/pages/utilities/orders-api.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _users_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users-service */ "./src/pages/utilities/users-service.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
/***/ "./src/pages/utilities/users-api.js":
/*!******************************************!*\
  !*** ./src/pages/utilities/users-api.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/pages/utilities/users-service.js":
/*!**********************************************!*\
  !*** ./src/pages/utilities/users-service.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   signUp: () => (/* binding */ signUp)
/* harmony export */ });
/* harmony import */ var _users_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./users-api */ "./src/pages/utilities/users-api.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
/* harmony import */ var _pages_utilities_users_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../pages/utilities/users-service */ "./src/pages/utilities/users-service.js");
...
const AppRouter = () => {
  const [user, setUser] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)((0,_pages_utilities_users_service__WEBPACK_IMPORTED_MODULE_4__.getUser)());
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _pages_NewOrderPage_NewOrderPage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../pages/NewOrderPage/NewOrderPage */ "./src/pages/NewOrderPage/NewOrderPage.js");
...
const routes = [{
  Component: _pages_NewOrderPage_NewOrderPage__WEBPACK_IMPORTED_MODULE_0__["default"],
  key: 'NewOrder',
  path: '/orders/new'
}, {
...
}`, "",{"version":3,"sources":["webpack://./src/components/Logo/Logo.module.scss"],"names":[],"mappings":"AAAA;EACI,cAAA;EACA,aAAA;EACA,aAAA;EACA,sBAAA;EACA,uBAAA;EACA,mBAAA;EACA,kBAAA;EACA,6BAAA;EACA,mBAAA;EACA,kBAAA;EACA,kCAAA;AACJ","sourcesContent":[".Logo {\r\n    height: 12vmin;\r\n    width: 12vmin;\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: center;\r\n    align-items: center;\r\n    border-radius: 50%;\r\n    background-color: var(--gray);\r\n    color: var(--tan-1);\r\n    font-size: 2.7vmin;\r\n    border: .6vmin solid var(--tan-2);\r\n    }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
___CSS_LOADER_EXPORT___.push([module.id, `.l6Ner7C7O5I4V69HVVgW {
  ...
  border: 0.1vmin solid rgb(57, 51, 40);
  border-radius: 2vmin;
  margin: 3vmin 0;
  padding: 3vmin;
  overflow-y: scroll;
...
.l6Ner7C7O5I4V69HVVgW .zqVYKU3SzotKremHzxQ_ {
  ...
  position: absolute;
  top: 50vh;
}`, "",{"version":3,"sources":["webpack://./src/components/OrderList/OrderList.module.scss"],"names":[],"mappings":"AAAA;EACI,aAAA;EACA,sBAAA;EACA,mBAAA;EACA,uBAAA;EACA,qCAAA;EACA,oBAAA;EACA,eAAA;EACA,cAAA;EACA,kBAAA;AACJ;;AAEI;EACA,YAAA;EACA,gBAAA;EACA,kBAAA;EACA,SAAA;AACJ","sourcesContent":[".OrderList {\r\n    display: flex;\r\n    flex-direction: column;\r\n    align-items: center;\r\n    background-color: black;\r\n    border: .1vmin solid rgb(57, 51, 40);\r\n    border-radius: 2vmin;\r\n    margin: 3vmin 0;\r\n    padding: 3vmin;\r\n    overflow-y: scroll;\r\n    }\r\n    \r\n    .OrderList .noOrders {\r\n    color: black;\r\n    font-size: 2vmin;\r\n    position: absolute;\r\n    top: calc(50vh);\r\n    }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
___CSS_LOADER_EXPORT___.push([module.id, `.RygkJgZmBHTETlLP3C3i {
  ...
  align-items: center;
  background-image: url("https://hdqwalls.com/wallpapers/minimalist-mountains-19.jpg");
  border-radius: 2vmin;
...
.RygkJgZmBHTETlLP3C3i h3 {
  ...
  cursor: pointer;
  font-family: "Rubik Iso";
}`, "",{"version":3,"sources":["webpack://./src/pages/AuthPage/AuthPage.module.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,aAAA;EACA,6BAAA;EACA,mBAAA;EACA,oFAAA;EAEA,oBAAA;EACA,wBAAA;AAAJ;;AAGE;EACE,iBAAA;EACA,kBAAA;EACA,yBAAA;EACA,eAAA;EACA,wBAAA;AAAJ","sourcesContent":[".AuthPage {\r\n    height: 100%;\r\n    display: flex;\r\n    justify-content: space-evenly;\r\n    align-items: center;\r\n    background-image: url('https://hdqwalls.com/wallpapers/minimalist-mountains-19.jpg');\r\n    //background-color: black;\r\n    border-radius: 2vmin;\r\n    font-family: 'Rubik Iso';\r\n  }\r\n  \r\n  .AuthPage h3 {\r\n    margin-top: 4vmin;\r\n    text-align: center;\r\n    color: rgb(242, 230, 230);\r\n    cursor: pointer;\r\n    font-family: 'Rubik Iso';\r\n  }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
.RZqTJBeYN7RXwcHgPFys aside {
  ...
  font-family: "Rubik Iso", cursive;
  font-family: "Rubik Pixels", cursive;
}`, "",{"version":3,"sources":["webpack://./src/pages/NewOrderPage/NewOrderPage.module.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,aAAA;EACA,sCAAA;EACA,uBAAA;EACA,iCAAA;EACA,oBAAA;EACA,yBAAA;EACA,sCAAA;EACA,iCAAA;EACA,oCAAA;AACJ;;AAEE;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;EACA,sCAAA;EACD,iCAAA;EACA,oCAAA;AACH","sourcesContent":[".NewOrderPage {\r\n    height: 100%;\r\n    display: grid;\r\n    grid-template-columns: 1.6fr 3.5fr 3fr;\r\n    grid-template-rows: 1fr;\r\n    background-color: rgb(44, 46, 47);\r\n    border-radius: 1vmin;\r\n    color: rgb(253, 253, 253);\r\n    font-family: 'Press Start 2P', cursive;\r\n    font-family: 'Rubik Iso', cursive;\r\n    font-family: 'Rubik Pixels', cursive;\r\n  }\r\n  \r\n  .NewOrderPage aside {\r\n    display: flex;\r\n    flex-direction: column;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    margin: 3vmin 2vmin;\r\n    font-family: 'Press Start 2P', cursive;\r\n   font-family: 'Rubik Iso', cursive;\r\n   font-family: 'Rubik Pixels', cursive;\r\n  }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
___CSS_LOADER_EXPORT___.push([module.id, `.U7F51i6q23MB43wS4GeC {
  height: 100%;
  display: grid;
  grid-template-columns: 1.2fr 3.5fr 3fr;
  grid-template-rows: 1fr;
  background-color: rgb(210, 155, 216);
  color: rgb(252, 251, 251);
  border-radius: 2vmin;
  border-color: rgba(87, 92, 92, 0.401);
...
.U7F51i6q23MB43wS4GeC .Gl976TgPIRmY9_yeWoZA {
  ...
  align-items: center;
  margin: 3vmin 2vmin;
}`, "",{"version":3,"sources":["webpack://./src/pages/OrderHistoryPage/OrderHistoryPage.module.scss"],"names":[],"mappings":"AAAA;EACI,YAAA;EACA,aAAA;EACA,sCAAA;EACA,uBAAA;EACA,oCAAA;EACA,yBAAA;EACA,oBAAA;EACA,qCAAA;EACA,0BAAA;AACJ;;AAEE;EACE,aAAA;EACA,sBAAA;EACA,8BAAA;EACA,mBAAA;EACA,mBAAA;AACJ","sourcesContent":[".OrderHistoryPage {\r\n    height: 100%;\r\n    display: grid;\r\n    grid-template-columns: 1.2fr 3.5fr 3fr;\r\n    grid-template-rows: 1fr;\r\n    background-color: rgb(210, 155, 216);\r\n    color: rgb(252, 251, 251);\r\n    border-radius: 2vmin;\r\n    border-color: rgba(87, 92, 92, 0.401);\r\n    font-family: 'Metal Mania';\r\n  }\r\n  \r\n  .OrderHistoryPage .aside {\r\n    display:grid;\r\n    flex-direction: column;\r\n    justify-content: space-between;\r\n    align-items: center;\r\n    margin: 3vmin 2vmin;\r\n  }"],"sourceRoot":""}]);
// Exports
___CSS_LOADER_EXPORT___.locals = {
...
/******/ })()
;
//# sourceMappingURL=App.61147b7761a1a6718b40bb55b2571aa1.js.map